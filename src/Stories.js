const stories = [
    ...
    {image:"./Images and videos/the-big-bang-theory.png",name:"bigbangth..."},
    {image:"./Images and videos/emicida.jpeg",name:"emicida"},
    {image:"./Images and videos/Hp.jpg",name:"wizarding..."},
    {image:"./Images and videos/legiao.jpg",name:"legiaourba..."},
    {image:"./Images and videos/flamengo.jpg",name:"flamengo"},
    {image:"./Images and videos/Pokemon_GO.png",name:"pokemongo"},
    {image:"./Images and videos/rick.png",name:"rickandmo..."},
]
